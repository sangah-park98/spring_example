...
//	트랜잭션 처리를 위한 PlatformTransactionManager 인터페이스 객체를 초기화 하기 위해 setter 메소드를
//	선언하고 servlet-context.xml 파일에서 초기화 시킨다.	
	...
	public void buyTicket(final CardVO cardVO) {
		logger.info("TransactionDAO 클래스의 buyTicket() 실행");
		
		// 트랜잭션 상태를 처리할 객체를 생성하고 PlatformTransactionManager 객체를 사용해 초기화 시킨다.
